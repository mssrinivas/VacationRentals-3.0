...
class OwnerAccount extends Component {
  ...
  SubmitChanges = () => {
   // var url = 'http://localhost:4004/editprofile/save/' + localStorage.getItem("ownery")

   var url = 'http://13.52.55.245:4004/editprofile/save/' + localStorage.getItem("ownery")
  ...
  componentWillMount() {
   ...
   var url = 'http://13.52.55.245:4004/user/account/' + localStorage.getItem("ownery")
